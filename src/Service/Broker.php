...
namespace Nue\SSOSamarinda\Service;

use Illuminate\Support\Facades\Cookie;
use Nue\SSOSamarinda\Exceptions\MissingConfigurationException;
...
class Broker extends SSOBroker
{
    ...
    {
        $this->ssoServerUrl = SSOSamarinda::config('server_url');
        $this->brokerName = SSOSamarinda::config('broker_name');
        $this->brokerSecret = SSOSamarinda::config('broker_secret');
