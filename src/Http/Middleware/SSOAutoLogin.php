...
namespace Nue\SSOSamarinda\Http\Middleware;

use Closure;
use Illuminate\Http\Request;
use Nue\SSOSamarinda\Service\Broker;
...
class SSOAutoLogin
{
    ...
    {
        $user = SSOSamarinda::config('model')::updateOrCreate([
    ...
    {
        return redirect($request->fullUrl())->cookie(cookie('sso_token_' . SSOSamarinda::config('broker_name')));
    }
